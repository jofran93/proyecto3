...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Crear el nuevo usuario directamente con create_user
        ...
        messages.success(request, f'¡El Usuario "{form.cleaned_data["username"]}" fue creado satisfactoriamente!')
    else:
...
def login_view(request):
    return render(request, 'login.html') #redirige a la pagina de
